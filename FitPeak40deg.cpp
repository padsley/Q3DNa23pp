...
//double p0 = 3.09849e-01, p1 = 6.45356e-06, p2 = -3.47323e-10;//pos->Brho calibration
double p0 = 3.09904e-01, p1 = 6.35616e-06, p2 = -3.12067e-10;
...
//     TH1F *histo = (TH1F*)gROOT->FindObjectAny("hPos__49");
    TFile *fNaF = TFile::Open("/home/padsley/data/Q3DNa23pp/rootfiles/run022_an.root");
    ...
    c1->Update();
    c1->SaveAs("figures/FitPeak0_40.png");
    
    fitty->SetRange(260,340);
    fitty->SetParameters(310,20.,-2.1,700,250,0);
//     fitty->SetParLimits(5,0.,0.);
    std::cout << "Ex = 23Na: 9072 keV" << std::endl;
    histoNaF->Fit(fitty,"BRME");
//     
    c1->Update();
    c1->SaveAs("figures/FitPeak1_40.png");
//     
    fitty->SetRange(825,920);
...
//     
    c1->Update();
    c1->SaveAs("figures/FitPeak2_40.png");
// //     
    fitty->SetRange(1075,1180);
    fitty->SetParameters(1136,17,-19,525,110);
//     std::cout << "Ex = 8864(4)-keV state in 19F" << std::endl;
    histoNaF->Fit(fitty,"BRME");
//     
    c1->Update();
    c1->SaveAs("figures/FitPeak3_40.png");
...
//     
    c1->Update();
    c1->SaveAs("figures/FitPeak4_40.png");
    
//     TFile *fC = TFile::Open("/home/padsley/data/Q3DNa23pp/rootfiles/run023_an.root");
//     TTree *tC = (TTree*)fC->Get("readout");
//     tC->Draw("pos>>histoC(620,0,2500)","pos>0","");
//     TH1F *histoC = (TH1F*)gROOT->FindObjectAny("histoC");
//     histoC->Draw("E");
//     
//     fitty->SetRange(680,820);
//     fitty->SetParameters(770,17,-3,600,100);
...
void FitRigidities()
{
    ...
    ge->SetPoint(ge->GetN(),1.13538e+03,0.317015);//8864(4)-keV state in 19F
    ge->SetPointError(ge->GetN()-1,3.84091e-01,0.000135036);
    
    ge->SetPoint(ge->GetN(),7.74786e+02,0.314635);//8871.9(5)-keV state in 16O
    ge->SetPointError(ge->GetN()-1,7.86802e-01,1.71103e-05);
    
    ge->SetPoint(ge->GetN(),3.11258e+02,0.311931);//9072(3)-keV state in 23Na
    ge->SetPointError(ge->GetN()-1,6.61320e-01,0.000102948);
    
    ge->SetPoint(ge->GetN(),1.95326e+03,0.321127);//8798.7-keV state in 23Na
    ge->SetPointError(ge->GetN()-1,5.06192e-01,2.66341e-05);
...
//     grint->SetLineColor(kGreen);
    ...
    c2->SaveAs("BrhoCalibration40deg.eps");
    c2->SaveAs("BrhoCalibration40deg.pdf");
    c2->SaveAs("BrhoCalibration40deg.png");
    c2->SaveAs("BrhoCalibration40deg.C");
...
//         (double Brho, double mass, double theta)
        ...
        gExErrors1sig->SetPoint(i,BrhoToExNaF(y,938.782980,40.),0);
        gExErrors1sig->SetPointError(i,0, 1000.*(BrhoToExNaF(y,938.782980,40.) - BrhoToExNaF(y + sig_y,938.782980,40.))); 
        ...
        gExErrors2sig->SetPoint(i,BrhoToExNaF(y,938.782980,40.),0);
        gExErrors2sig->SetPointError(i,0, 1000.*(BrhoToExNaF(y,938.782980,40.) - BrhoToExNaF(y + sig_y,938.782980,40.))); 
        
        x = grint3->GetPointX(i);
        y = grint3->GetPointY(i);
        sig_y = grint3->GetErrorYhigh(i);
        
        gExErrors3sig->SetPoint(i,BrhoToExNaF(y,938.782980,40.),0);
        gExErrors3sig->SetPointError(i,0, 1000.*(BrhoToExNaF(y,938.782980,40.) - BrhoToExNaF(y + sig_y,938.782980,40.))); 
        
//         std::cout << "i = " << i << " y = " << y << "\t sig_y = " << sig_y << std::endl;
        gEx3sig_ActualValues->SetPoint(i,BrhoToExNaF(y,938.782980,40.),1000.*(BrhoToExNaF(y,938.782980,40.) - BrhoToExNaF(y + sig_y,938.782980,40.)));
    }
        ...
        c3->SaveAs("ExUncertaintyBand40deg.eps");
        c3->SaveAs("ExUncertaintyBand40deg.pdf");
        c3->SaveAs("ExUncertaintyBand40deg.png");
        c3->SaveAs("ExUncertaintyBand40deg.C");
        Draw23NaExSpectrum();
}
...
//     TH1F *histoNaF = (TH1F*)gROOT->FindObjectAny("histoNaF");
    ...
    tNaF->Draw("BrhoToExNaF(Brho,938.782980,40.)>>hEx23Na(450,8.7,9.15)","pos>0 && pos<2500","");
    ...
    tC->Draw("BrhoToExNaF(Brho,938.782980,40.)>>hEx19F(450,8.7,9.15)","pos>0 && pos<2500","goff");
...
//     b11->Draw("same");
    ...
    */
    c4->Update();
    c4->SaveAs("Na23_Ex_40deg_PA.eps");
    c4->SaveAs("Na23_Ex_40deg_PA.pdf");
    c4->SaveAs("Na23_Ex_40deg_PA.C");
}
